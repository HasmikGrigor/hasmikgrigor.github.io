...
let langArr={
    ...
    "sliderText":{
        "hy":"FINEXO.com-ը վերջնական պորտալն է, որտեղ և՛ սկսնակները, և՛ ավելի առաջադեմ հաճախորդները գտնում են այն ամենը, ինչ անհրաժեշտ է իրենց առևտրային կարողությունները բարձրացնելու և աշխարհի ամենահայտնի ակտիվներին մուտք գործելու համար: FINEXO.com-ը կարճաժամկետ նպատակ է դրել ստեղծել պարզ և հեշտ օգտագործվող առևտրային միջավայր բոլոր մակարդակների թրեյդերների համար: Մենք գերազանցել ենք այս ակնկալիքները և այդ ժամանակից ի վեր վերածվել ենք առցանց առևտրի բազմազգ և բազմալեզու ապրանքանիշի:",
        "ru":"FINEXO.com — это идеальный портал, на котором как новички, так и более продвинутые клиенты найдут все необходимое для улучшения своих торговых способностей и доступа к самым популярным активам в мире. FINEXO.com поставил перед собой краткосрочную цель по созданию простой и удобной торговой среды для трейдеров всех уровней. Мы превзошли эти ожидания и с тех пор превратились в многонациональный и многоязычный бренд в сфере онлайн-торговли.",
        "en":"Explicabo esse amet tempora quibusdam laudantium, laborum eaque magnam fugiat hic? Esse dicta aliquid error repudiandae earum suscipit fugiat molestias, veniam, vel architecto veritatis delectus repellat modi impedit sequi."
    },
    "sliderBtn":{
        "hy":"Կարդալ ավելին",
        "ru":"Читать болee",
